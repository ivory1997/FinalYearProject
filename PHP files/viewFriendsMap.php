...
$mysql_query1 = "SELECT email FROM users WHERE name ='$friend_name'";
$result1 = mysqli_query($conn,$mysql_query1);
if(mysqli_num_rows($result1)>0){
	$row1 = mysqli_fetch_assoc($result1);
	$friend_email = $row1["email"];
}
$mysql_query = "SELECT * FROM countries WHERE email = '$friend_email'";
